 ...
 */
public class SlicingGUI extends JFrame {
  ...
  private List<String> transitionRules = new ArrayList<>();
  /** The String list of variable rules. */
  private List<String> variableRules = new ArrayList<>();
  /** The String list of variable options. */
  private List<String> variableOptions = new ArrayList<>();
  private JTextField varOptionField;

  public static void main(String[] args) {
    SlicingGUI g = new SlicingGUI(new ArrayList<String>(), new ArrayList<String>());
    g.setVisible(true);
  }
   ...
   */
  public SlicingGUI(List<String> transitions, List<String> variables) {
    init(transitions, variables);
  }
  ...
  public void init(List<String> transitions, List<String> variables) {
    ...
    setTitle("Slicing Script Builder");
    ...
    btnWriteScript.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        SliceScriptWriter writer = new SliceScriptWriter();
    ...
    btnRemoveTrn.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (index < 0) {
          JOptionPane.showMessageDialog(SlicingGUI.this, "No transition rule selected!");
          return;
        }
    ...
    btnRemoveVar.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (index < 0) {
          JOptionPane.showMessageDialog(SlicingGUI.this, "No variable rule selected!");
          return;
        }
    ...
    btnTrnAdd.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        try {
          ...
          JOptionPane.showMessageDialog(SlicingGUI.this, "Value [" + value + "] is not a valid number");
          return;
        }
    ...
    btnVarOptionRemove.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (index < 0) {
          JOptionPane.showMessageDialog(SlicingGUI.this, "No variable option selected!");
          return;
        }
